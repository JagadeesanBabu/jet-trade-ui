...
export const getTradeDataByRSI = (params) => async dispatch => {
  try {
    ...
    const start = params.startDate ? moment(params.startDate, 'YYYY-MM-DD').format("YYYY-MM-DD") : null;
    const end = params.endDate ? moment(params.endDate, 'YYYY-MM-DD').format("YYYY-MM-DD") : null;
